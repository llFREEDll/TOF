...
createTituloTest("Test 1", "En seguida se presentará una lista de actividades en las cuales quizás hayas tenido alguna experiencia personal. La finalidad es que determines que tan apto te consideras para cada una de ellas. Para indicarlo selecciona uno de los siguientes números 1, 2, 3 o 4 guiándote por las explicaciones que siguen:\na)	1 si te consideras incompetente para esta actividad\nb)	2 si te consideras medianamente apto\nc)	3 si te consideras bastante apto\nd)	4 si te consideras muy apto");
...
const Evaluar = () =>{ // cuando se oprime el boton de evaluar las respuestas del test
  ...
  */
  ...
  alert("Verbal="+arrayResultados[0]+" puntos\n"+
        "Numerica="+arrayResultados[1]+" puntos\n"+
        "Mecanica y Constructiva="+arrayResultados[2]+" puntos\n"+
        "Artistico-Plastica="+arrayResultados[3]+" puntos\n"+
        "Musical="+arrayResultados[4]+" puntos\n"+
        "Científica="+arrayResultados[5]+" puntos\n"+
        "Social="+arrayResultados[6]+" puntos\n"+
        "Destreza manual="+arrayResultados[7]+" puntos\n"+
        "Practica="+arrayResultados[8]+" puntos\n"+
        "Ejecutiva="+arrayResultados[9]+" puntos\n"+
